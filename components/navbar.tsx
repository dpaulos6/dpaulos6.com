      ...
      <div className="flex w-full max-w-7xl justify-between items-center">
        ...
        <div className="flex gap-2">
          <a
            ...
            className="hidden h-10 md:h-12 flex gap-2 items-center justify-center text-text p-2 rounded-xl hover:bg-text/5 hover:text-primary transition whitespace-nowrap"
            download
          >

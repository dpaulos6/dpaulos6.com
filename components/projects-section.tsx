  ...
  return (
    <div className="w-screen h-auto flex flex-col gap-20 items-center text-text py-12">
      <div className="flex flex-col items-center gap-12 pt-12 w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6 w-full max-w-5xl p-8">
          <TooltipProvider delayDuration={0}>
            {projects
              ...
              .map((project, i) => (
                <div
                  key={i}
                  className={`flex justify-center items-center w-full  p-[2px] rounded-[0.9rem] overflow-hidden transition-all group relative`}
                >
                  ...
                  <div className="flex flex-col w-full h-full gap-4 p-6 rounded-xl bg-background-menu z-10">
                    <div className="relative w-full h-32 md:h-40 lg:h-48">
                      <Image
                        ...
                        fill
                        className="object-cover rounded-xl border border-text/10"
                      />
                      <Badge
                        className={cn(
                    ...
                    <div className="flex flex-col gap-2 py-2 pr-2">
                      ...
                      <div className="flex flex-wrap gap-4 mt-auto select-none">
                        {project.technologies.map((tech, j) => (
                          <Tooltip key={j}>
                            <TooltipTrigger className="h-fit rounded-md flex items-center justify-center p-1 rounded-md transition hover:bg-primary/15 hover:text-primary">

...
const BackgroundAudio: React.FC = () => {
  ...
  return (
    <div className="fixed min-w-[332px] w-full p-4 xs:w-fit flex flex-col gap-2 right-1/2 translate-x-1/2 -bottom-[4.5rem] md:right-0 md:-translate-x-0 text-text hover:bottom-0 group transition-all !duration-500">

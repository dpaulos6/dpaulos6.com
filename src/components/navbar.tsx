...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-0 left-0 w-full h-fit flex flex-row justify-between xl:px-[10%] px-8 py-4 z-50 select-none">
      <div>
      ...
      <div className="flex items-center gap-6 md:gap-6">
        <ul className="hidden md:flex flex-row gap-6 text-xl lowercase">
